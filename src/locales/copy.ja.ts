    ...
    items: [
      {
        ...
        a: '最も本物らしいラップランドのお土産は、地元の職人の手によるものです。プーッコ（フィンランドの伝統的なベルトナイフ）、ククサ（白樺のこぶから削り出したカップ）、トナカイ革製品、ウール織物、そしてクラウドベリージャム、リンゴンベリーの保存食、白樺樹液製品などの自然の恵みです。サーミの伝統工芸ドゥオッジ、銀細工、角細工、織りバンドは最も価値が高いとされます。作り手の名前や原産地証明書のあるものをお選びください。',
      },
      {
