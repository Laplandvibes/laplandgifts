...
export const HOME_META: Record<Lang, { title: string; description: string }> = {
  ...
  en: {
    title: 'Finnish gifts and Lapland souvenirs',
    description:
    ...
    title: 'Lapin tuliaiset ja suomalaiset lahjat',
    description:
  ...
  'pt-BR': {
    title: 'Presentes finlandeses e souvenirs da Lapônia',
    description:
