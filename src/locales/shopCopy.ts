...
const de: ShopCopy = over({
  ...
  category: {
    names: {
      ...
      treats: 'Süßes und kulinarische Geschenke',
      superfoods: 'Arktische Beerenpulver',
      merch: 'Lappland-Shirts und Merch',
      experiences: 'Erlebnisgeschenke aus Lappland',
    },
    intro: {
      design: 'Moomin-Becher, Glas von Iittala, Marimekko und Holzschmuck von Aarikka: das finnische Design, das wirklich mit nach Hause reist. Jedes Stück verschickt der finnische oder nordische Shop, der es verkauft.',
      ...
      treats: 'Finnische Süßigkeiten und Essgeschenke: Salmiak, Fazer-Schokolade, Tee von Nordqvist und Moomin, Moomin-Kaffee, Rentier-Trockenfleisch und Sanddornmarmelade. Die Einfuhrregeln sind von Land zu Land verschieden, prüfen Sie also den Lieferhinweis auf der Karte.',
...
const sv: ShopCopy = over({
  ...
  category: {
    names: {
      ...
      treats: 'Sötsaker och matpresenter',
      superfoods: 'Arktiska bärpulver',
      merch: 'Lapplandströjor och merch',
      experiences: 'Upplevelsepresenter från Lappland',
    },
    intro: {
      design: 'Moominmuggar, glas från Iittala, Marimekko och träsmycken från Aarikka: den finska design som faktiskt följer med hem. Varje sak skickas av den finska eller nordiska butik som säljer den.',
      ...
      treats: 'Finska sötsaker och matgåvor: salmiak, choklad från Fazer, te från Nordqvist och Moomin, Moomin-kaffe, torkat renkött och havtornssylt. Införselreglerna skiljer sig åt mellan länder, så läs fraktnoteringen på kortet.',
...
const fr: ShopCopy = over({
  ...
  category: {
    names: {
      ...
      merch: 'T-shirts et souvenirs de Laponie',
  ...
  experience: {
    ...
    groups: {
      ...
      reindeer: 'Rennes',
      icebreaker: 'Croisière brise-glace',
...
const es: ShopCopy = over({
  ...
  category: {
    names: {
      ...
      merch: 'Camisetas y souvenirs de Laponia',
      experiences: 'Experiencias de Laponia para regalar',
    },
    intro: {
      design: 'Tazas Moomin, vidrio de Iittala, Marimekko y joyas de madera de Aarikka: el diseño finlandés que de verdad tiene un lugar en su casa. Cada pieza sale de la tienda finlandesa o nórdica que la vende.',
  ...
  experience: {
    ...
    groups: {
      ...
      reindeer: 'Renos',
      icebreaker: 'Crucero en rompehielos',
...
const it: ShopCopy = over({
  ...
  category: {
    names: {
      ...
      merch: 'T-shirt e souvenir della Lapponia',
      experiences: 'Esperienze in Lapponia da regalare',
    },
    intro: {
      design: 'Tazze Moomin, vetro Iittala, Marimekko e gioielli in legno Aarikka: il design finlandese che torna davvero a casa con Lei. Ogni pezzo parte dal negozio finlandese o nordico che lo vende.',
  ...
  experience: {
    ...
    groups: {
      ...
      reindeer: 'Renne',
      icebreaker: 'Crociera sul rompighiaccio',
...
const ptBR: ShopCopy = over({
  ...
  category: {
    names: {
      ...
      merch: 'Camisetas e souvenirs da Lapônia',
  ...
  experience: {
    ...
    groups: {
      ...
      reindeer: 'Renas',
      icebreaker: 'Cruzeiro em quebra-gelo',
...
const ja: ShopCopy = over({
  ...
  category: {
    ...
    intro: {
      ...
      clothing: 'ハルティのシェルジャケット、ヘルシンキ発のマキアのストリートウェア、そしてオウルの自社工場で編まれるノースアウトドアのメリノニット。',
      ...
      superfoods: '北極圏のベリーパウダー、チャーガ、そしてロヴァニエミで作られるアークティック・ウォリアーズのハーブ製品。いずれもフィンランドの生産者によるものです。',
  ...
  boutique: {
    ...
    townNames: {
      rovaniemi: 'ロヴァニエミ', inari: 'イナリ', posio: 'ポシオ',
      levi: 'レヴィ', sodankyla: 'ソダンキュラ', yllas: 'ユッラス',
      saariselka: 'サーリセルカ', enontekio: 'エノンテキオ', utsjoki: 'ウツヨキ',
    },
...
const ko: ShopCopy = over({
  ...
  category: {
    ...
    intro: {
      design: '무민 머그, 이딸라 유리, 마리메꼬, 아리카의 나무 장신구까지. 실제로 집까지 따라오는 핀란드 디자인입니다. 모든 상품은 판매하는 핀란드 또는 북유럽 상점에서 발송됩니다.',
