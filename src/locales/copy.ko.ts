    ...
    items: [
      {
        ...
        a: '가장 진정한 라플란드 기념품은 현지 장인의 손에서 나옵니다. 푸코(핀란드 전통 벨트 나이프), 쿡사(자작나무 옹이를 깎아 만든 컵), 순록 가죽 제품, 모직물, 그리고 클라우드베리 잼, 링곤베리 보존식품, 자작나무 수액 제품 같은 자연의 산물입니다. 사미 두오지 공예품, 은세공, 뿔 세공, 짜임 끈이 가장 귀하게 여겨집니다. 공항 매장의 대량 생산품보다 만든 사람의 이름이나 원산지 증명서가 있는 제품을 찾으세요.',
      },
      {
