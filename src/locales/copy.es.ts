...
const es: ChromeCopy = {
  ...
  related: {
    ...
    items: [
      { label: 'Navidad en Laponia y Papá Noel', blurb: 'Pueblo de Papá Noel, escapadas navideñas y consejos de temporada.', href: 'https://laplandchristmas.com' },
      ...
      { label: 'Planifique su viaje a Laponia', blurb: 'Destinos, estaciones y consejos prácticos para la Laponia finlandesa.', href: 'https://laplandvisit.com' },
    ],
  },
  footer: {
    pillars: [
