...
const it: ChromeCopy = {
  ...
  hero: {
    ...
    titleAccent: 'Artico',
    lead: "Presto potrà ordinare autentici regali della Lapponia mentre è in vacanza e ritrovarli a casa prima del Suo ritorno. Tesori artigianali, oggetti di design ed esperienze artiche, direttamente dalla Lapponia finlandese. La prima collezione è in fase di selezione.",
