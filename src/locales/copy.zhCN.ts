...
const zhCN: ChromeCopy = {
  ...
  faq: {
    ...
    items: [
      {
        q: '在拉普兰可以买到哪些正宗的纪念品？',
        a: '最正宗的拉普兰纪念品出自当地工匠之手：普科刀（芬兰传统腰刀）、库克萨木杯（用桦木瘤雕成的杯子）、驯鹿皮制品、羊毛织物，以及云莓果酱、越橘蜜饯和桦树汁制品等野生食材。萨米传统工艺（杜奥德吉），银饰、鹿角制品和编织带，最为珍贵。请认准工匠姓名或原产地证书。',
      },
      {
  ...
  footer: {
    ...
    editorialNote: '由 LaPeso Oy（企业代码 3309136-7）独立运营 · 最后审阅：2026年5月 · 我们直接与精选工匠和商家合作，并在每个商品页面上完整披露。',
