...
const ptBR: ChromeCopy = {
    ...
    items: [
      {
        ...
        tag: 'Marca própria',
        description: 'Canecas, camisetas, moletons e impressões em tela com nossos designs árticos característicos. Impressão sob demanda e envio mundial assim que a loja abrir.',
      },
      {
        name: 'Artesanato',
        tag: 'Feito à mão',
  ...
  valueProp: {
    ...
    sub: 'Chega de espremer lembrancinhas frágeis na mala. É assim que a LaplandGifts vai funcionar quando a loja abrir: você compra durante a viagem, nós cuidamos do resto.',
    steps: [
  ...
  productGrid: {
    h2: 'Em breve',
    sub: 'Nossa primeira coleção está sendo selecionada entre os melhores artesãos da Lapônia. A newsletter conta quando algo novo chega.',
  ...
  newsletter: {
    ...
    body: 'Você recebe acesso imediato aos dois guias árticos. Nas cartas, compartilho achados de butiques e os artesãos por trás deles.',
  ...
  shipping: {
    ...
    sub: 'O que você pode esperar quando a loja LaplandGifts abrir',
    items: [
