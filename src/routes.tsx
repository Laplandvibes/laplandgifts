 ...
 * categories.ts:ssä.
 *
 * `/gift-guides` ja `/shipping` liittyvät tähän Task 12:ssa, kun sivut ovat
 * olemassa. Reittiä ei julisteta ennen kuin sillä on sivu: muuten linkki
 * navissa veisi 404:ään, jonka päälle murupolku piirtäisi oikean näköisen
 * polun.
 */
export const CONTENT_PATHS: string[] = ['/', ...CATEGORIES.map((c) => c.slug)]
