...
export default function ConsentControls({ lang }: { lang: Lang }) {
  ...
  return (
    <section className="mt-10 rounded-2xl border border-line bg-sand-deep p-6">
      <h2 className="font-heading text-2xl tracking-wide text-gray">{c.h}</h2>
      ...
      {state !== null && (
        <>
          <button
            ...
            className="mt-4 inline-flex min-h-11 items-center rounded-full border border-line bg-card px-5 py-2.5 font-body text-sm text-gray transition-colors hover:border-pink hover:text-pink"
          >
            {c.withdraw}
          </button>
